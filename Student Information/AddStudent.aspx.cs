...
namespace Student_Information
{
    ...
    public partial class AddStudent : System.Web.UI.Page
    {
        ...
        {
            FileInfo fl = new FileInfo("D:\\ESPIRE Training\\Dot Net\\Student Information\\Student.txt");
            ...
            s.WriteLine(obj[0].ToString() + "," + obj[1].ToString() + "," + obj[2].ToString() + "," + obj[3].ToString() + "," + obj[4].ToString() + "," + obj[5].ToString() + "," + obj[6].ToString() + "," + obj[7].ToString() + "," + obj[8].ToString() + "," + obj[9].ToString());
            s.Close();
        ...
        {
            FileInfo fl = new FileInfo("D:\\ESPIRE Training\\Dot Net\\Student Information\\Student.txt");
            FileStream fs = fl.Open(mode: FileMode.Open, access: FileAccess.Read, share: FileShare.Read);
